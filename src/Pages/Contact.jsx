        ...
        <main className='w-[1000px] h-fit bg-white mx-20 px-15 py-15 rounded-2xl grid place-content-center sticky top-10'>
            <section className='w-full grid place-content-cente'>
                ...
                <form className="w-[380px] space-y-7">
                    ...
                    <button onClick={SendMessage} className="w-full bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 rounded-lg shadow-md transition-all duration-200">
                        Send
                    </button>
                </form>
            </section>
